...
const label = { night: 'Night', day: 'Day' }
</script>

<template>
  <div class="player-panel">
    <div class="panel-row">
      <span class="player-name"><PhaseIcon :phase="side" :size="16" /> {{ label[side] }}</span>
...
.hp-bar-fill { height: 100%; border-radius: 5px; transition: width 0.5s ease; }
